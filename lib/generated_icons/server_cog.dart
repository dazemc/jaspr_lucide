...
class ServerCog extends jaspr.StatelessComponent {
  ...
  return s.svg(
    [      s.path(d: 'm10.852 14.772-.383.923', []),
      ...
      s.path(d: 'M4.5 10H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v4a2 2 0 0 1-2 2h-.5', []),
      s.path(d: 'M4.5 14H4a2 2 0 0 0-2 2v4a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-4a2 2 0 0 0-2-2h-.5', []),
      s.path(d: 'M6 18h.01', []),
      s.path(d: 'M6 6h.01', []),

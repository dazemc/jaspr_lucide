...
class Pointer extends jaspr.StatelessComponent {
  ...
  return s.svg(
    [      s.path(d: 'M22 14a8 8 0 0 1-8 8', []),
      ...
      s.path(d: 'M18 11a2 2 0 1 1 4 0v3a8 8 0 0 1-8 8h-2c-2.8 0-4.5-.86-5.99-2.34l-3.6-3.6a2 2 0 0 1 2.83-2.82L7 15', []),],
    width: width,
    height: height,
    viewBox: viewBox,
    key: key,
